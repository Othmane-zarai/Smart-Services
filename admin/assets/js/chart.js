...
$(document).ready(function() {
  ...
  /*======== 10. GRADIENT LINE CHART 2 ========*/
  var line = document.getElementById("line2");
  if (line !== null) {
    line = line.getContext("2d");
    var gradientFill = line.createLinearGradient(0, 120, 0, 0);
    gradientFill.addColorStop(0, "rgba(252, 20, 20,0.10196)");
    gradientFill.addColorStop(1, "rgba(252, 20, 20,0.30196)");
...
/*======== 21. BAR CHART11 ========*/
var bar1 = document.getElementById("barChart11");
if (bar1 !== null) {
  var myChart = new Chart(bar1, {
    type: "bar",
    data: {
